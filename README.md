...
The container starts the API server automatically. Pass Azure credentials via environment variables — all values are resolved at runtime, no IDs hardcoded:
